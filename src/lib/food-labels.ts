 ...
 * эмодзи по группе. Ключи — фактические значения `Ingredient.group` из БД: это
 * русские подписи 13 групп сида (prisma/seed-data.ts пишет `group: G.<key>`, где
 * объект G хранит именно подписи). Значки — из таблицы spec.md (тикет 12/03).
 */
